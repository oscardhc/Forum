...
class G {
    ...
    static let viewStyle = StoredObject<[String: Int]>("ForumViewStyle", { .init() }) // 0: ok, 1: fold, 2: hide
    static let threadStyle = StoredObject<Int>("ForumThreadStyle", { 1 })
    static let floorStyle = StoredObject<Int>("ForumFloorStyle", { 1 })
